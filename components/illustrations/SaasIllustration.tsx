...
export function SaasIllustration() {
  return (
    <div className="w-full h-[450px] md:h-[500px] bg-[#0a0a1a] rounded-xl p-6 md:p-8 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-56 h-56 bg-purple-600/10 rounded-full blur-3xl"></div>
      <div className="absolute top-1/2 left-1/2 w-32 h-32 bg-blue-600/5 rounded-full blur-2xl"></div>
        ...
        <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-[10px]">Production Ready</div>
                </div>
              </div>
              <div className="flex items-center gap-1">
                <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></div>
                <span className="text-green-400 text-[10px]">En ligne</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-950/30 to-blue-950/30 border border-green-500/30 rounded-lg p-2 flex items-center gap-2">
            ...
            <div className="flex-1">
              ...
              <div className="text-gray-500 text-[9px]">Hébergement Europe • Chiffrement E2E</div>
            </div>
          </div>
        </div>
      </div>
