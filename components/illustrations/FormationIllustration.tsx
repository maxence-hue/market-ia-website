    ...
    <div className="w-full h-[400px] bg-[#0a0a1a] rounded-xl p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="text-center mb-6">
          ...
          <h3 className="text-white text-lg mb-1 font-semibold">
        ...
        <div className="grid grid-cols-3 gap-3 flex-1">
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-3 hover:border-violet-500/50 transition-all group">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500 to-pink-500 flex items-center justify-center mb-2 shadow-lg shadow-violet-500/30">
              <Brain className="w-4 h-4 text-white" />
            </div>
            <h4 className="text-white mb-0.5 text-xs font-medium">
              Introduction à l&apos;IA
            </h4>
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-3 hover:border-violet-500/50 transition-all group">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-gray-400 text-[10px]">67%</span>
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-3 hover:border-violet-500/50 transition-all group">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-gray-400 text-[10px]">33%</span>
            </div>
          </div>
        ...
        <div className="mt-4 pt-4 border-t border-white/10">
          ...
          <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
            <div className="w-[55%] h-full bg-gradient-to-r from-pink-500 to-violet-500 rounded-full"></div>
          </div>
        </div>
      </div>
    </div>
